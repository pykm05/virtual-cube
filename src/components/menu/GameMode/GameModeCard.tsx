...
export default function GameModeCard({ gameMode, setGameMode }: GameModeCardProps) {
    return (
        <div className="w-[250px]">
            <div className="flex flex-col w-[200px] rounded-[10px] text-sm rounded shadow-lg p-3 gap-2 bg-gray-200">
                ...
                >
                    <Image src="/controller.svg" height={30} width={30} priority={true} alt="controller icon" />
                    <div>Unrated</div>
                </button>
                ...
                >
                    <Image src="/clock.svg" height={30} width={30} priority={true} alt="clock icon" />
                    <div>Coming soon...</div>
                </button>
                ...
                >
                    <Image src="/swords.svg" height={20} width={20} priority={true} alt="swords icon" />
                    <div>Coming soon...</div>
                </button>
            </div>
        </div>
