...
class Send {
    ...
    static error(res: Response, data: any = null, message = 'error') {
    ...
    static notFound(res: Response, data: any = null, message = 'not found') {
    ...
    static unauthorized(res: Response, data: any = null, message = 'unauthorized') {
    ...
    static forbidden(res: Response, data: any = null, message = 'forbidden') {
    ...
    static badRequest(res: Response, data: any = null, message = 'bad request') {
